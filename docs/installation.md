...
(`http://127.0.0.1:8080`), привяжите сертификат и ограничьте доступ по IP (access-лист,
появится в v2) или базовой аутентификацией. Так трафик к панели идёт по HTTPS.
